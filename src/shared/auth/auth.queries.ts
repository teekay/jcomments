...
const createPasswordResetTokenIR: any = {"name":"createPasswordResetToken","params":[{"name":"id","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":244,"b":245,"line":5,"col":85}]}},{"name":"accountId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":249,"b":257,"line":5,"col":90}]}},{"name":"token","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":261,"b":265,"line":5,"col":102}]}},{"name":"createdAt","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":269,"b":277,"line":5,"col":110}]}},{"name":"expiresAt","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":281,"b":289,"line":5,"col":122}]}}],"usedParamSet":{"id":true,"accountId":true,"token":true,"createdAt":true,"expiresAt":true},"statement":{"body":"INSERT INTO password_resets (id, account_id, token, created_at, expires_at) VALUES (:id, :accountId, :token, :createdAt, :expiresAt)","loc":{"a":159,"b":290,"line":5,"col":0}}};
...
const isTokenUsableIR: any = {"name":"isTokenUsable","params":[{"name":"token","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":363,"b":367,"line":8,"col":43}]}},{"name":"date","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":407,"b":410,"line":8,"col":87}]}}],"usedParamSet":{"token":true,"date":true},"statement":{"body":"SELECT * FROM password_resets WHERE token=:token AND used_at IS NULL AND expires_at > :date","loc":{"a":320,"b":410,"line":8,"col":0}}};
...
const accountFromTokenIR: any = {"name":"accountFromToken","params":[{"name":"token","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":531,"b":535,"line":11,"col":88}]}}],"usedParamSet":{"token":true},"statement":{"body":"SELECT a.* FROM accounts a JOIN password_resets p ON (a.id=p.account_id) WHERE p.token=:token","loc":{"a":443,"b":535,"line":11,"col":0}}};
...
const changePasswordIR: any = {"name":"changePassword","params":[{"name":"password","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":603,"b":610,"line":14,"col":37}]}},{"name":"accountId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":639,"b":647,"line":14,"col":73}]}}],"usedParamSet":{"password":true,"accountId":true},"statement":{"body":"UPDATE accounts SET password=digest(:password::text, 'sha256') WHERE id=:accountId","loc":{"a":566,"b":647,"line":14,"col":0}}};
